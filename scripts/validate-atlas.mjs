...
const EXPECTED={'atlas.json':[2234,3432],'atlas-female.json':[888,1073],'atlas-tcia-female.json':[36,36],'atlas-denver-female.json':[128,203],'atlas-nlm-vhf-ct.json':[114,148],'atlas-dhcp-neonatal.json':[85,85]};
